export class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        //  Clickable Dots (Makes board as well):
        this.load.atlas('dots', 'assets/dots.png', 'assets/dots.json');
        this.load.image( 'board', 'assets/dotsOne.png' );

        //  Borders:
        this.load.atlas('b1', 'assets/border1.png', 'assets/b1.json');
        this.load.image( 'stickH', 'assets/stick.png' );
        this.load.image( 'stickV', 'assets/stickV.png' );

        //  Ball:
        this.load.atlas('ball', 'assets/ball.png', 'assets/ball.json');

        //  Goals:
        this.load.image( 'blueG', 'assets/BlueGoal.png' );
        this.load.image( 'orangeG', 'assets/OrangeGoal.png' );
    }
